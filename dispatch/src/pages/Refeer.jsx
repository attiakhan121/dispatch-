...
function Refeer() {
  return (
    <div className="div">
      {/* header */}
      <div className="flex justify-center items-center bg-[url('https://resolute-logistics.com/optimized/uploads/services/reefer-dispatch-service_768.webp')] bg-cover bg-center bg-no-repeat overflow-x-hidden 2xl:h-[50vh] h-[100vh] relative">
        ...
        <div className="flex flex-col lg:flex-row mt-20 lg:mt-40 gap-6 lg:gap-10 mb-2 px-4 lg:px-0 w-full max-w-7xl">
          ...
          <div className="img-cont max-w-full lg:max-w-[45vw] w-full">
            <img
              ...
              src="/public/dry-van-dispatch.jpg"
              alt=""
              loading="lazy"
